...
const uint64_t PRE_BLOCK_REWARD	                             = UINT64_C(840000000000000000);
...
const int      P2P_DEFAULT_PORT                              =  7865;
const int      RPC_DEFAULT_PORT                              =  7080;
...
const char* const SEED_NODES[] = { 
  "seed1.catalyst.cash:7865",
  "seed2.catalyst.cash:7865",
};
