...
const uint64_t MINIMUM_FEE                                   = UINT64_C(1000000); // for now Minimum fee would be 0.001 XAT for a while 
...
const char     GENESIS_COINBASE_TX_HEX[]                     = "010601ff0001c5f5b7d9a43a029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd088071210189b75a22d556b2ae8b68032fdec1d2375b0969a144155a9ab810a3c8045bdb96";
...
const int      P2P_DEFAULT_PORT                              =  6790;
const int      RPC_DEFAULT_PORT                              =  6795;
...
const char* const SEED_NODES[] = { 
  "seed1.catalyst.cash:6790",
  "seed2.catalyst.cash:6790",
};
